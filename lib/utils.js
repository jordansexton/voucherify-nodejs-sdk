...
module.exports = {
  calculatePrice: function calculatePrice(basePrice, voucher, unitPrice) {
    ...
    if (voucher.discount.type === 'PERCENT') {
      ...
      var _newPrice = basePrice - unitPrice * discount;

      return roundMoney(_newPrice > 0 ? _newPrice : 0);
    } else {
      throw new Error('Unsupported discount type.');
    }
  },

  calculateDiscount: function calculateDiscount(basePrice, voucher, unitPrice) {
    var e = 100; // Number of digits after the decimal separator.
    var discount = void 0;
